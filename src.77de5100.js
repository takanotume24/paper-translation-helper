...
function () {
  ...
  OriginalInputHandler.prototype.doWork = function (event) {
    var target = event.target;
    var original_element = target;
    OriginalInputHandler.showResult(original_element);
  };

  OriginalInputHandler.showResult = function (original_element) {
    ...
    var strings = source.split(". ").map(function (str) {
      return str + ".";
    });
    var results = this.spilit_array(strings);
    console.log(results);
    converted_element.innerHTML = this.show_boxes(results);
  };

  OriginalInputHandler.show_boxes = function (stringss) {
    var _this = this;

    var result = "";
    var i = 0;
    stringss.forEach(function (strings) {
      result += _this.in_box(strings.join(""), i++);
    });
    return result;
  };

  OriginalInputHandler.in_box = function (string, colmn_num) {
  ...
  OriginalInputHandler.spilit_array = function (strings) {
    var char_count = 0;
    var results = [];
    var i = 0;
  ...
  OriginalInputHandler.WORD_LIMIT = 4500;
